jQuery(document).ready(function () {
    (function ($) {
        ...
        $(function () {
            ...
            $("#amount").val("$" + $(".fincan-range-slider").slider("values", 0) +
                " - $" + $(".fincan-range-slider").slider("values", 1));
        });
        ...
        $('.product-view-mode a').on('click', function (e) {
            ...
            if (shopProductWrap.hasClass('grid')) {
                $('.fincan-product').removeClass('product-view--list')
            } else {
                $('.fincan-product').addClass('product-view--list')
            }
        });
